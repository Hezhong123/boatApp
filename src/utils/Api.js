...
// export const url = 'http://192.168.3.2:3003'
...
export const AwsToken= async (filename)=>{
    return fetch(`${url}/aws`, {
        method: 'POST',
        headers: {
...
export const _Authorization = async (path, extension) => {
